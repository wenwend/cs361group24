...
var completedDonationDetails = require('./app_server/routes/completedDonationDetails');
var postDonation = require('./app_server/routes/postDonation');
var completedDonations = require('./app_server/routes/completedDonations');
...
app.use('/completedDonationDetails', completedDonationDetails);
...
app.use('/confirmDonation', confirmDonation);
